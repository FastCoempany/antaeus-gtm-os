...
Phase 4  ──  Negotiation room rebuild              ✅ closed (Phase 4 PR — this entry)
Phase 5  ──  Static public face                    ← next under rigid ordering
              (landing / auth / privacy / category framing)
              ↓
              Gate down → beta
```
