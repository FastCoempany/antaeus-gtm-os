...
| 012 | [Skill scheduling (Phase E of the orchestration layer)](./adr-012-skill-scheduling-2026-05-31.md) | APPROVED 2026-05-31. Builds on ADR-010 (skills). Server-side cron-style scheduling; on app load operator is auto-routed to the result room (founder pick E1-A). |
