...
| Onboarding | onboarding-seeding-flow-2026-07-07.html | The Earned Depth seeding flow (doorway → ICP → accounts → wake-up → live deals → quota → landing; citable evidence margin; ≥10-deal judgment floor). Governed by ADR-019 + canon §12. Companion validated prototypes: onboarding-reveal / onboarding-deals-middle / onboarding-front-half. |
