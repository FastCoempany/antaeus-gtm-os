...
| Territory Architect | focus, account grouping, territory edits | focus edits, intentional tier changes | next focus to build, account clustering, tier recommendation | best saved ICP, current territory gaps | territory bridge, object-model guidance, next-output logic |
