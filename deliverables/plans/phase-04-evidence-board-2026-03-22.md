...
| EB-R05 | Some user-facing failures are still swallowed instead of surfaced. | Silent failure destroys trust and makes debugging impossible for real users. | Phase 16 patched explicit boot-state handling into [app/discovery-studio/index.html](c:/AppDev/v1AntaeusApp/Appv2_290126/app/discovery-studio/index.html) and [app/discovery-agenda/index.html](c:/AppDev\v1AntaeusApp\Appv2_290126\app\discovery-agenda\index.html), but broader swallowed catches still exist in other modules. | Product Shell & Navigation | Phase 16 | P0 | local-patch |
