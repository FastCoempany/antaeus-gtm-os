...
| EB-R02 | Sidebar scroll position resets instead of respecting where the user clicked. | It breaks continuity in a long nav and makes the shell feel unstable. | Audit and user report; [js/nav.js](c:/AppDev/v1AntaeusApp/Appv2_290126/js/nav.js) rebuilds sidebar HTML and does not persist scroll position. | Product Shell & Navigation | Phase 14 | P1 | open |
