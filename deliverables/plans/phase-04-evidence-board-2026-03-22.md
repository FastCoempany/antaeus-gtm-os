...
| EB-R10 | Week 1 lifecycle nudge can duplicate in the sidebar. | Duplicate lifecycle chrome makes the activation shell feel unstable and noisy. | Live browser screenshot on [app/icp-studio/index.html](c:/AppDev/v1AntaeusApp/Appv2_290126/app/icp-studio/index.html) showed two identical `Week 1 · Return to Dashboard` chips after Phase 24. | Auth, Onboarding & Activation | Phase 24 follow-up | P2 | open |
