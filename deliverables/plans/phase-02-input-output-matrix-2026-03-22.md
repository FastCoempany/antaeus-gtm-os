...
| Territory Architect | define territory strategy | ICP strongly recommended | territory focuses, account tiering, calibration decisions | state history and calibration logic | territory structure, tiering, account state | `gtmos_territory` and TA sequence docs | sourcing, outbound, playbook | demo-supported | still feels like abstract planning with no account consequences |
