...
- Moved ICP, focus, territory, and next-move summaries into shared shell metrics.
...
- Added shared header state logic for focus, queue, and ready-account progression.
