// Version C candidate: baseline-faithful branch used to continue command-layer work
// without letting exploratory artifacts overwrite the approved visual direction.
...
const OBJECTS = [
  ...
  },
  {
    ...
    lenses: [
      { id: "definition", label: "Definition", module: "ICP Studio", cue: "Keep the full ICP logic and buyer method intact." },
      { id: "territory", label: "Territory", module: "Territory Architect", cue: "Territory is a lens on the same target truth, not a new room." },
      { id: "sourcing", label: "Sourcing", module: "Sourcing Workbench", cue: "Source from the live ICP instead of a disconnected list." },
    ],
  },
  {
