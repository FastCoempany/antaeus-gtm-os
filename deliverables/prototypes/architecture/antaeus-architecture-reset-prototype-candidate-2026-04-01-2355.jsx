// Version E candidate: corrects Grid back to a true peer scan surface so the
// layout no longer implies promotion behavior that the interaction does not support.
