(function(){
  ...
  var seeds = [
    ...
    { id:"global-contractor-management", label:"Global Contractor Management / EOR / Global Employment", storageKey:"gcm", aliases:["global-contractor-management","global contractor management","gcm","eor","employer of record","global employment","global payroll","contractor compliance","worker classification","deel","remote","papaya global","velocity global","oyster","multiplier"], systems:"EOR platforms, contractor payment rails, local entities, and manual compliance spreadsheets across jurisdictions", asset:"global employment compliance", flow:"global hiring, classification, and contractor payment workflow", shortFlow:"global hiring workflow", fallback:"legal and finance still rescue classification calls, local compliance, and multi-country payroll by hand", fallbackCap:"Legal and finance still rescue classification calls, local compliance, and multi-country payroll by hand", scaleSignal:"hiring across many countries, a contractor-heavy workforce, and manual compliance load", scaleMetric:"countries hired in, contractor-vs-employee mix, and compliance hours", painAxes:"misclassification risk, compliance cost, payment reliability, speed to hire", painSurface:"Every new country adds classification risk and manual compliance that legal and finance absorb by hand.", triggerPressure:"A new-country expansion, a misclassification scare, an audit, or a contractor population that outgrew the spreadsheet is forcing the issue.", vendorPressure:"Spreadsheets, local providers, and one-off entity setups feel familiar even when they are slow and risky.", pressureCompare:"misclassification exposure, slow onboarding, and fragmented local compliance", ownerRoles:"Head of People Ops, Finance, Legal/Compliance, and Global Mobility all hold pieces.", proofNeed:"compliance coverage in their actual countries and classification accuracy on their real workers", nextReview:"A working review with People Ops and the Finance or Legal owner.", routeFocus:"Carry the classification risk, country footprint, owner map, and next compliance review forward.", opening:"Mostly. We can pay people, but classification and local compliance still sit with legal and finance every time we enter a new country.", openingNext:"Where does that rescue happen first today: classifying contractors, multi-country payroll, or staying compliant per jurisdiction?", current:"We use a mix of contractor payments, local providers, and spreadsheets, but compliance and classification still get stitched together by hand.", currentNext:"What part of the global hiring workflow breaks first when you enter a new country or a contractor count grows?", pain:"Misclassification and slow, manual compliance create real legal exposure and slow every global hire down.", trigger:"A new-market push, an audit or penalty scare, or a contractor population that outgrew the manual process made this active now.", owner:"People Ops feels the speed pain, but Finance and Legal control whether the compliance model can change.", proof:"We would need to trust compliance coverage in our actual countries and the classification calls on our real workers before this moves.", vendor:"The current mix of contractor payments, local entities, and spreadsheets is risky, but it feels familiar enough to defend.", decision:"People Ops would sponsor, Finance would weigh the cost, Legal and Compliance would hold veto on classification, and procurement would follow.", next:"Bring People Ops and the Finance or Legal owner into the next review so we can pressure-test one real country or one risky contractor population.", handoff:"Deal Workspace gets the classification risk and owner map. Call Planner gets the next compliance review. Future Autopsy gets any unresolved legal exposure or soft urgency." },
  ];
