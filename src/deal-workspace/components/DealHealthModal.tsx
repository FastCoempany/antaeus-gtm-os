 ...
 *      LossReasonModal pre-loaded with the deal id; otherwise close.
 */
...
export function DealHealthModal(): JSX.Element | null {
    ...
    // Reset draft when a different deal opens.
    useEffect(() => {
        setDraft(deal);
    }, [deal?.id]);
    ...
    return (
        <div class="dw-modal-overlay is-active" role="dialog" aria-modal="true">
            <div class="dw-modal dw-modal--health">
                <header class="dw-modal__header">
                    <h2 class="dw-modal__title">
                        {draft.accountName || "(untitled deal)"}
                    </h2>
                    <button
                        type="button"
