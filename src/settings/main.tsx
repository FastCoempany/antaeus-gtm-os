...
import { SettingsV4 } from "./v4/SettingsV4";
...
// Wire-to-production v4 (canon §4.20, the safe deposit, settled
// 2026-07-07). Default ON; room_settings_v4_off is the kill-switch
...
const useV4 =
    v4Param === "1" ||
    (v4Param !== "0" && !isFeatureEnabled("room_settings_v4_off"));

render(
    useV4 ? <SettingsV4 /> : useDsSurface ? <SettingsDS /> : <Settings />,
    root
);
