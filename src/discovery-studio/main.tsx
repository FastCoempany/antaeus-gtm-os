...
import { DiscoveryStudioV4 } from "./v4/DiscoveryStudioV4";
...
// Wire-to-production v4 (canon §4.12, the live cockpit, settled
// 2026-07-07 — the protected/premium room, wired last with the most
// passes). Default ON; room_discovery_v4_off is the kill-switch back
// to the DS surface; ?v4=0/1 is the preview hatch.
const v4Param = (() => {
    try {
...
const useV4 =
    v4Param === "1" ||
    (v4Param !== "0" && !isFeatureEnabled("room_discovery_v4_off"));

render(
    useV4 ? <DiscoveryStudioV4 /> : useDsSurface ? <DiscoveryStudioDS /> : <DiscoveryStudio />,
    root
);
