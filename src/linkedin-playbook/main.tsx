...
import { LinkedInPlaybookV4 } from "./v4/LinkedInPlaybookV4";
...
// Wire-to-production v4 (canon §4.10, "the one move", settled
// 2026-07-06). Default ON; room_linkedin_playbook_v4_off is the
...
const useV4 =
    v4Param === "1" ||
    (v4Param !== "0" && !isFeatureEnabled("room_linkedin_playbook_v4_off"));
