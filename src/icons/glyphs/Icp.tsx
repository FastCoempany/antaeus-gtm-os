/**
 * Icp — "ICP" glyph, generated from the iconography mockup
...
export function IcpGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <rect x="4" y="4" width="16" height="16"/><circle cx="12" cy="10" r="2.4"/><path d="M7.5 17a4.5 4.5 0 0 1 9 0"/>
        </svg>
    );
}
