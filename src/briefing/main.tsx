...
import { BriefingV4 } from "./v4/BriefingV4";
...
// Wire-to-production v4 (canon §4.21) — the shipped structure with the
// vivid ambient layer (greeting + ticker). Default ON;
// room_briefing_v4_off is the kill-switch; ?v4=0/1 hatches.
const v4Param = (() => {
    try {
...
const useV4 =
    v4Param === "1" ||
    (v4Param !== "0" && !isFeatureEnabled("room_briefing_v4_off"));

render(useV4 ? <BriefingV4 /> : useDsSurface ? <BriefingDS /> : <Briefing />, root);
